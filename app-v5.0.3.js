...
window.switchMobileTab=function(tabName){
  try{
    ...
    console.error("Mobile tab switch failed",err);
...
function diaryOptions(){
  ...
  const search=(E.diaryItemSearch.value||"").trim().toLowerCase();
...
$("#addDiaryBtn").onclick=()=>{E.diaryEditId.value="";$("#diaryDialogTitle").textContent="Add to diary";E.diaryItemTypeFilter.value="food";E.diaryCategoryFilter.value="";E.diaryRecipeLabelFilter.value="";E.diaryItemSearch.value="";diaryOptions();E.diaryQuantity.value=1;updateDiaryCalc();E.addDiaryDialog.showModal();addQuantityShortcuts()}
...
E.diaryItemSearch.oninput=()=>{diaryOptions();E.diaryQuantity.value=1;updateDiaryCalc()};
